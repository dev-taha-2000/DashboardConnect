...
<div class="w-50 m-auto" > 
    <form method="POST" action="{{route('staff.store')}}" enctype="multipart/form-data">   
        ...
        <div class="mb-3">
          ...
          <input type="text" name="profession" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"> 
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">definition</label>
          <textarea name="definition" class="form-control" id="" ></textarea> 
        </div>
        <div class="mb-3">
