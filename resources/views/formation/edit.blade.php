...
<div class="w-50 m-auto" > 
    <form method="POST" action="{{route('formation.update',$formation->id)}}"> 
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{$formation->nome}}" name="nome" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"> 
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">description</label>
          <textarea name="description"  class="form-control" id="" >{{$formation->description}}</textarea>
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" value="{{$formation->image}}" class="form-label">image</label>   
